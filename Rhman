...
\033[1;93m
✮ ꧁☬ 𝐵𝒜𝐿❁𝒞𝐻  ࿐  ✮
 \033[1;96m          WHATSAPP NO 03199093782
"""
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=100079537070273/')
##### LICENSE #####
#=================#
def lisensi():
    os.system('clear')
